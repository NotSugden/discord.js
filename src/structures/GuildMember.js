...
class GuildMember extends Base {
   ...
   */
  get kickable() {
    return this.manageable && this.guild.me.hasPermission(Permissions.FLAGS.KICK_MEMBERS);
  }
   ...
   */
  get bannable() {
    return this.manageable && this.guild.me.hasPermission(Permissions.FLAGS.BAN_MEMBERS);
  }
